...
fig1.text(0.5, 0.94, "Heartphase Version 0.0.7", ha='center', va='bottom', fontsize=14, color='gray', alpha=0.2)
...
fig2.text(0.5, 0.94, "Heartphase Version 0.0.7", ha='center', va='bottom', fontsize=14, color='gray', alpha=0.2)
